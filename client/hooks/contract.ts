...
// ============================================================
// Permissionless Voting — Contract Methods
// ============================================================

/**
 * Vote for a candidate (one vote per wallet).
 * If candidate doesn't exist, it's automatically created.
...
/**
 * Get all candidates (read-only).
 * Calls: get_all_candidates() -> Vec<String>
 */
...
/**
 * Check if an address has voted (read-only).
 * Calls: has_voted(voter: Address) -> bool
 */
